                ...
                <div className={s.chats_wrapper}>
                    {chats.map((chat, key) =>
                        <div key={key}>
                            ...
                            <br/>
                            <span
                                className={s.chat_name}> {chat.name === 'Teem chat' ? messages[messages.length - 1].nickname + ':' + messages[messages.length - 1].message : ''} </span>
                        </div>
                    )}
                </div>
            </div>
